    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Viewport className="fixed inset-0 z-50 grid place-items-center p-4">
        <AlertDialogPrimitive.Popup
          ...
          className={cn(
            "relative z-50 grid w-full max-w-lg gap-4 rounded-lg border bg-background p-6 text-sm text-foreground shadow-lg ring-1 ring-foreground/10",
...
function AlertDialogOk({
  ...
  return (
    <AlertDialogPrimitive.Close
      data-slot="alert-dialog-ok"
      render={<Button type="button" variant="default" className={className} />}
      {...props}
    >
      {children}
    </AlertDialogPrimitive.Close>
